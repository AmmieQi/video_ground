...
def run_training():
    ...
    max_steps = 20000
    batch_size = 56
    train_csv_path = "./data/TACoS/train_clip-sentvec.pkl"
    test_csv_path = "./data/TACoS/test_clip-sentvec.pkl"
    test_feature_dir="./data/Interval128_256_overlap0.8_c3d_fc6/"
    train_feature_dir = "./data/Interval64_128_256_512_overlap0.8_c3d_fc6/"
